...
const PersonsForm = ({
  ...
  return (
    <form
      className={`absolute inset-0 transition-all ease-in-out duration-700  border-[#333333]  border rounded-lg flex items-center justify-center flex-col z-20 bg-black -translate-x-1/2 h-1/2  left-1/2 w-5/6 sm:w-4/6 max-w-lg min-h-[350px] px-10 gap-7 ${
